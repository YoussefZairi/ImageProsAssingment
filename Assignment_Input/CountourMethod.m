...
title('Objected Detection');

figure;

% Define the subplot layout (2 rows, 3 columns)
subplot(3, 2, 1);
imshow(I_edge);
...
saveas(gcf, 'subplot_output_3x2.png');
...
%Step 11: Calculate metrics for final image
...
%Step 12: Display final image results
fprintf('\nOverall Similarity:\n');
fprintf('Dice Score: %.4f\n', dice_final);
fprintf('Precision: %.4f\n', precision_final);
fprintf('Recall: %.4f\n', recall_final);
